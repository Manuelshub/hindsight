...
/**
 * The repository's own seeded PRNG. Borrowed rather than reimplemented so that a fixture
 * built by `schemas/fixtures.ts` and a probe sample drawn here cannot silently diverge.
 */
export { rng } from '../../../schemas/fixtures.js';

export type { DecideFn } from '../../scoring/src/backtest.js';
export { computeStats, scoreDecision } from '../../scoring/src/backtest.js';

export { WARMUP, buildSnapshot, renderSnapshot } from '../../market/src/indicators.js';
export { getCandles } from '../../market/src/feed.js';

export { BASELINES } from '../../agent/src/baseline.js';
export { createAdapterBrain } from '../../agent/src/adapter.js';
export {
  MEASURED_INPUT_PRICE_OG,
  MEASURED_OUTPUT_PRICE_OG,
  createInferenceBrain,
} from '../../agent/src/inference.js';
